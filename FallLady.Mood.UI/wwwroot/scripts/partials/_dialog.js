    ...
    define(["jquery"], function ($) {
        ...
        $.fn.dialog = function (options) {
            return this.each(function () {
                var $this, initDialog;
                $this = $(this);
                initDialog = new dialog($this, options);
                initDialog.init();
                window.modal = $this;
                return $this;
            });
        ...
        $.fn.dialog.defaults = {
            ...
            cancelBtnClassName: "btn btn-default btn-raised",
            saveBtnClassName: "btn btn-primary btn-raised",
            onBeforeClose: null,
            onClose: null,
            onAfterClose: null,
            onBeforeOpen: null,
            ...
            dialog.prototype.init = function () {
                ...
                if (opts.showFooter === true) {
                    ...
                    if (opts.showBtnSave) {
                        ...
                        //console.log(opts.saveBtnClassName + ' ' + opts.saveBtnLabel) ;
