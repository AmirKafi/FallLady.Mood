    ...
    Layout.prototype.fix = function () {
        ...
        if ($('body').hasClass(ClassName.fixed)) {
            ...
            if (windowHeight >= sidebarHeight) {
                //bg - gradient - fruit$(Selector.contentWrapper).css('min-height', windowHeight - neg)
                //bg-gradient-fruit$(Selector.contentWrapper).css('min-height',"100%")

                postSetHeight = windowHeight - neg
            } else {
                //bg-gradient-fruit$(Selector.contentWrapper).css('min-height', sidebarHeight)
                //bg-gradient-fruit$(Selector.contentWrapper).css('min-height', "100%")
